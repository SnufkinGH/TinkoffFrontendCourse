...
const CreateCard = () => {
    ...
    return <Container style={{textAlign: "center"}}>
        <Typography align="center" variant="h4" className="mt-3 mb-3">{param.id ? 'Редактирование фильма' : 'Добавить новый фильм'}</Typography>
        ...
        <Button onClick={param.id ? editMovie : saveMovie} className="mt-3" variant="contained" sx={{backgroundColor: '#e53059'}}style={{borderRadius: "20px", width: "30vw"}}>Подтвердить</Button>
    </Container>
}
