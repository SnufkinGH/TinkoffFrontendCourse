    ...
    return (
        <Container>
            <InputGroup className="mb-3 mt-3">
                ...
                <Button className="ml-3" variant="contained" sx={{backgroundColor: '#e53059'}} style={{borderRadius:10}} endIcon={<SearchIcon/>} onClick={() => setStr(document.getElementById('form').value)}>Искать</Button>
            </InputGroup>
